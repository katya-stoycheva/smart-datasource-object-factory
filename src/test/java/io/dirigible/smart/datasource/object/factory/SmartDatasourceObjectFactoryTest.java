...
public class SmartDatasourceObjectFactoryTest {
	...
	public void cleanEnv() {
		testEnv = new HashMap<String, String>();
	}
	
	@Test
	public void testPrefixDelimiterDefaultValueIfNoneSet() {
		SmartDatasourceObjectFactory sof = new SmartDatasourceObjectFactory();
		String result = sof.getPrefixDelimiter(testEnv);
